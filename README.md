...
- **model_Reso32.pth**, **model_Reso32HR.pth** and **model_Reso64.pth** are our pre-trained models, and their properties are as follows:  
    ...
    |  Pre-trained Models   | Feature map's Reso | Result's Reso | 1080Ti | 3090 |
    |  ----  | :-:   |  :-:   | :-:   | :-:   |
    | model_Reso32  | 32 x 32 | 256 x 256 | \~14 fps | \~43fps |
    | model_Reso32HR  | 32 x 32 | 512 x 512 | \~13 fps | -- fps |
    | model_Reso64  | 64 x 64 | 512 x 512 | \~3 fps | -- fps |
